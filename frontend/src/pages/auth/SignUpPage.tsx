...
export function SignUpPage() {
  return (
    <div className="h-screen flex items-stretch bg-gray-100">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white hight-screen overflow-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/auth/sign-in" className="text-blue-600 font-semibold hover:text-blue-700">
              Sign in
            </Link>
          </div>
        </div>
